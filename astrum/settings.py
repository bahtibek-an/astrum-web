"""
Django settings for astrum project.
...
SECRET_KEY = 'django-insecure-l7+0r5tv*(iuy$k#6hbvpgfd+j!hqhf%l1a=z&p+mjca79m!uz'
...
WSGI_APPLICATION = 'astrum.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "ASTRUM IT ACADEMY",
    "copyright": "ASTRUM IT ACADEMY",
    "user_avatar": None,
